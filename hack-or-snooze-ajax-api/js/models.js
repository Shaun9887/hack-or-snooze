...
class User {
  ...
  //Add/Remove favorite story to favorites list
  ...
  //Updating API with updateType being add/remove

  async _addOrRemoveFavorites(updateType, story) {
    const method = updateType === "add" ? "POST" : "DELETE";
   ...
   /** Return true/false if story is a favorite of this user. */
